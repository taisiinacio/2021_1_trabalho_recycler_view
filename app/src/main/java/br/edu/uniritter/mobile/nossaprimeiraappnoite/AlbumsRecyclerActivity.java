...
import br.edu.uniritter.mobile.nossaprimeiraappnoite.adapter.AlbumAdapter;
import br.edu.uniritter.mobile.nossaprimeiraappnoite.model.Album;

public class AlbumsRecyclerActivity extends AppCompatActivity
   ...
   //LAYOUT
        setContentView(R.layout.activity_recycler_album);
   ...
   //DADOS DO INTENT
    ...
    public void onResponse(JSONArray response) {
        try {
            ...
            RecyclerView rv = findViewById(R.id.rv_album);
           ...
           // StaggeredGridLayoutManager sglm = new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL);
            ...
            AlbumAdapter albumAdapter = new AlbumAdapter(albums,R.layout.item_album);
